...
public class UartService extends Service {
    ...
    //public static final UUID TX_CHAR_UUID = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb"); //Same as RX_CHAR

    //public static final UUID SENSORTAG_KEY_SERVICE = UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");
    //public static final UUID SENSORTAG_KEY_DATA = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
